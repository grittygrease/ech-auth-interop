...
func TestInteropGoSignatureForRust(t *testing.T) {
	...
	// PR #2: method=0 for RPK (was 1), NotAfter is first field
	// ech_auth_encoded_hex generated by current implementation (PR2 compliant)
	expectedEncoded, _ := hex.DecodeString("000000000070dbd880002c302a300506032b6570032100d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a080700408ca4021885d35a609b8dcbbd33ee0d09590f77720b4c4c4d74984b67bcc20d7e01a9f72061da2711dcda84cf3073544b05960141a004de11335da2513375d009")
...
func TestInteropBidirectional(t *testing.T) {
	...
	// Encode (Explicitly PR2 for interop)
	encoded := auth.EncodeVersioned(SpecPR2)

	// Decode (Explicitly PR2)
	decoded, err := DecodeVersioned(encoded, SpecPR2)
	if err != nil {
		t.Fatalf("decode failed: %v", err)
	}
	// PR #2: Wire format does not contain trusted keys (they come from DNS).
	// Restore them manually to simulate the verification context.
	decoded.TrustedKeys = auth.TrustedKeys
	...
	t.Logf("signature_hex: %x", sig.SignatureData)
	// Expect PR2 format
	echAuthEncodedHex := "000000000077359400002c302a300506032b657003210079b5562e8fe654f94078b112e8a98ba7901f853ae695bed7e0e3910bad04966408070040f7634d208426c698eb7e0de0e8822d997df4ceeb9dad9cba9595484ca14bde6b5e9999833f2f0b912e4503774dd8a74be295c99c3b3d32cba6660badb1c5590b"
	if hex.EncodeToString(encoded) != echAuthEncodedHex {
		t.Errorf("Encoded mismatch:\n got: %x\n want: %s", encoded, echAuthEncodedHex)
	}
	t.Logf("ech_auth_encoded_hex: %x", encoded)
}
